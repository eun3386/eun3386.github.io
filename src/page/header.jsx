...
export const Header = () => {
  ...
  const menu = [
    { menuName: "Index,", href: "/" },
    { menuName: "Patreon,", href: "/patreon" },
    { menuName: "Store,", href: "/store" },
    { menuName: "About,", href: "/about" },
    { menuName: "Lab", href: "/lab" },
  ];

  return (
    <header className="sh fixed top-0 left-0 w-full z-[1000] pt-25 s:pt-35 text-white mix-blend-difference will-change-transform js-i-fade">
      <div className="site-max relative flex justify-between items-center">
        <a href="/" className="flex relative nuxt-link-active">
          <div
            className="relative overflow-hidden whitespace-nowrap v-enter-to"
            style={{ display: "none" }}
          >
            <div
              className="relative inline-flex js-logo-slide"
              style={{
                translate: "none",
                rotate: "none",
                scale: "none",
          ...
          <div className="absolute top-1/2 -translate-y-1/2 w-[17.6rem] s:w-[12rem] h-auto overflow-hidden">
            <svg
              viewBox="0 0 160 20"
              xmlns="http://www.w3.org/2000/svg"
              className="w-full h-auto js-logo-slide"
              style={{
                translate: "none",
                rotate: "none",
                scale: "none",
        ...
        <ul className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden s:flex gap-x-5">
          {menu.map((val) => {
            return (
              <li
        ...
        <button
          type="button"
          className="hidden s:inline-flex relative text-white opacity-100 uline-double"
        >
          Send me a message
        </button>
      </div>
